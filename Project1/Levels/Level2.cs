...
namespace Project1.Levels
{
    public class Level2 : ILevel
    {
        ...
        public Level2(Camera _camera, Texture2D _fish, Texture2D _crab, Texture2D _diver, Texture2D _jellyfish, Texture2D _anker, Texture2D _treasure, Texture2D _lifes, Texture2D _finish, Texture2D _background, SchatkistCollision _SCollision, EnemyCollision _ECollision)
        {
            camera = _camera;
            fish = new Fish(_fish, new KeyBoardReader());
            crab = new Crab(_crab);
            crab2 = new Crab(_crab)
            {
